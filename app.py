...
# Modelo para a tabela SpotifyTrack
class SpotifyTrack(db.Model):
    id = db.Column(db.String, primary_key=True)  # id do Spotify
    track_name = db.Column(db.String, nullable=False)
    artist = db.Column(db.String, nullable=False)
    album = db.Column(db.String)
    release_date = db.Column(db.String)  # para simplificar
...
# Script para importar CSV no banco
